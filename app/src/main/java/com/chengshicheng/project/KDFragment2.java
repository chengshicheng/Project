 ...
 */
public class KDFragment2 extends KDTabBaseFragment {
    ...
    public static KDFragment2 newInstance(Context context, Bundle bundle) {
        KDFragment2 newFragment = new KDFragment2();
