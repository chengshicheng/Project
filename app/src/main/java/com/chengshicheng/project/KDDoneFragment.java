 ...
 */
public class KDDoneFragment extends KDTabBaseFragment {
    ...
    public static KDDoneFragment newInstance(Context context, Bundle bundle) {
        mContext = context;
        KDDoneFragment newFragment = new KDDoneFragment();
